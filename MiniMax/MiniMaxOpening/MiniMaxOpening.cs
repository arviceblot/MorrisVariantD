...
namespace MiniMaxOpening
{
    ...
    {
        /**
         * This program plays a move in the opening phase of the game.
         * It does not verify that the position is, indeed, and opening position.
         * We assume that this game never goes into the midgame phase.
         */
